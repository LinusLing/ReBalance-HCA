...
def train(cfg, local_rank, distributed, logger):
    ...
    for iteration, (images, targets, _) in enumerate(train_data_loader, start_iter):
        ...
        loss_dict, relation_loss = model(images, targets)
        ...
        relation_loss_dict_reduced = reduce_loss_dict(relation_loss)
        relaton_losses_reduced = sum(loss for loss in relation_loss_dict_reduced.values())
        meters.update(loss=relaton_losses_reduced, **relation_loss_dict_reduced)
